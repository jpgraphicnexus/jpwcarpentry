        ...
        <div className="container mx-auto px-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbPage>Small Carpentry Jobs</BreadcrumbPage>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h3 className="text-2xl md:text-3xl font-bold mb-6">Carpentry Services Across Hampshire</h3>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              From small repairs to bespoke furniture, we provide expert carpentry services throughout Hampshire
            </p>
          </div>
            ...
            <Link to="/portsmouth-carpentry-services" className="group">
              <Card className="text-center p-6 bg-white hover:shadow-lg transition-shadow group-hover:border-golden/50">
                <CardContent className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">Built-in Storage & Repairs</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/chichester-carpentry-services" className="group">
              <Card className="text-center p-6 bg-white hover:shadow-lg transition-shadow group-hover:border-golden/50">
                <CardContent className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">Period Joinery & Restoration</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/havant-carpentry-services" className="group">
              <Card className="text-center p-6 bg-white hover:shadow-lg transition-shadow group-hover:border-golden/50">
                <CardContent className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">Family Storage Solutions</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/gosport-carpentry-services" className="group">
              <Card className="text-center p-6 bg-white hover:shadow-lg transition-shadow group-hover:border-golden/50">
                <CardContent className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">Marine Storage & Repairs</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/fareham-carpentry-services" className="group">
              <Card className="text-center p-6 bg-white hover:shadow-lg transition-shadow group-hover:border-golden/50">
                <CardContent className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">Bespoke Executive Carpentry</p>
                </CardContent>
              </Card>
            </Link>
          </div>
