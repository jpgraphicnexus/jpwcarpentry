...
export const seoConfig: SEOConfig = {
  ...
  '/': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/',
  ...
  '/about': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/about',
    ogImage: '/assets/carpenter-working.jpg'
  },
  ...
  '/services': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/services',
    ogImage: '/assets/carpenter-working.jpg'
  },
  ...
  '/services/kitchen-renovations': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/services/kitchen-renovations',
  ...
  '/services/small-carpentry-jobs': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/services/small-carpentry-jobs',
  ...
  '/services/home-renovations': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/services/home-renovations',
  ...
  '/services/general-building-works': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/services/general-building-works',
  ...
  '/portsmouth-carpentry-services': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/portsmouth-carpentry-services',
    ogImage: '/assets/carpenter-working.jpg'
  },
  ...
  '/chichester-carpentry-services': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/chichester-carpentry-services',
    ogImage: '/assets/carpenter-working.jpg'
  },
  ...
  '/havant-carpentry-services': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/havant-carpentry-services',
    ogImage: '/assets/carpenter-working.jpg'
  },
  ...
  '/gosport-carpentry-services': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/gosport-carpentry-services',
    ogImage: '/assets/carpenter-working.jpg'
  },
  ...
  '/fareham-carpentry-services': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/fareham-carpentry-services',
    ogImage: '/assets/carpenter-working.jpg'
  },
  ...
  '/past-works': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/past-works',
    ogImage: '/assets/carpenter-working.jpg'
  },
  ...
  '/blog': {
    ...
    canonicalUrl: 'https://jpwcarpentry.com/blog',
    ogImage: '/assets/carpenter-working.jpg'
  }
};
...
export const getBlogPostSEO = (slug: string, title: string, excerpt: string, tags: string[]): SEOData => {
  return {
    ...
    keywords: tags.join(', '),
    canonicalUrl: `https://jpwcarpentry.com/blog/${slug}`,
    ogImage: '/assets/carpenter-working.jpg'
  };
};